...
- [ ] 03-01-PLAN.md — Audio capture: AVAudioRecorder wrapper + RecordingSession actor state machine (Wave 1)
- [ ] 03-02-PLAN.md — Dual-engine transcription: TranscriberRouter + SpeechAnalyzer/whisper.cpp + SmallEnDownloader (Wave 1)

**Wave 2** *(blocked on Wave 1 completion)*

- [ ] 03-03-PLAN.md — Vault writing + pipeline wiring: NSFileCoordinatorNoteWriter + HardcodedVaultResolver + PipelineWiring (Wave 2)
- [ ] 03-04-PLAN.md — Menu-bar popover UI: MenuBarViewModel + MenuBarPopover + MenuBarExtra wiring (Wave 2)
...
| 3. macOS Capture + Transcribe | 0/4 | Planned | - |
